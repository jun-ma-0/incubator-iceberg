 ...
 * interface to get information about tombstone values with the table's current snapshot
 */
public interface SupportsTombstoneFilters extends DataSourceReader {

  /**
   * Returns the table's configured tombstone field
   */
  String tombstoneField();
