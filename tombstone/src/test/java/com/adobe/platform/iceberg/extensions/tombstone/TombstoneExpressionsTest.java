...
public class TombstoneExpressionsTest {
    ...
    public void notIn() {
        ...
        Assert.assertEquals("(((ref(name=\"fld\") != \"a\" and ref(name=\"fld\") != \"b\") and ref(name=\"fld\") != \"c\") and ref(name=\"fld\") != \"d\")",
                exp.toString());
    ...
    public void matchesAny() {
        Optional<Expression> optExp = TombstoneExpressions.matchesAny("fld2", Lists.newArrayList("m", "n", "o", "p"));
        Assert.assertTrue(optExp.isPresent());
        Expression exp = optExp.get();
        Assert.assertEquals("(((ref(name=\"fld2\") == \"m\" or ref(name=\"fld2\") == \"n\") or ref(name=\"fld2\") == \"o\") or ref(name=\"fld2\") == \"p\")",
                exp.toString());
